...
import { Calculator as CalculatorIcon, ArrowRight, AlertTriangle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-900 rounded-lg p-4 space-y-4">
              ...
              <div className="pt-2">
                <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">建议止损价格</p>
                <div className="flex items-center gap-3">
                  <span className="text-3xl font-bold text-indigo-400 font-mono">
                    {result.stopPrice.toFixed(2)}
                  </span>
                  {parseFloat(values.currentPrice) < result.stopPrice ? (
                    <span className="bg-red-500/20 text-red-400 px-2 py-1 rounded text-xs font-bold border border-red-500/50 flex items-center gap-1">
                      <AlertTriangle className="w-3 h-3" /> 已止损
                    </span>
                  ) : (
                    <span className="bg-green-500/20 text-green-400 px-2 py-1 rounded text-xs font-bold border border-green-500/50 flex items-center gap-1">
                       <CheckCircle2 className="w-3 h-3" /> 持仓中
                    </span>
                  )}
                </div>
              </div>
               ...
               <div className="pt-2">
                 <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">状态</p>
